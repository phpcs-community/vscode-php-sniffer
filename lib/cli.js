 ...
 * @prop {number} [timeout=0]
 *   Maximum time in seconds to wait for the process before killing it.
 ...
 *
 * @return {Promise<{stdout: string, stderr: string}|null>}
 *   An object with stdout and stderr if the command executed successfully,
 *   or `null` if it was cancelled by the token.
 *
